...
import com.gaia.hermes.pushnotification.PushNotificationResult;
...
public class WindowsPhonePNSTest {
	public static void main(String[] args) {
		...
		PushNoficationApi api = new WindowsPhonePNS(
				"ms-app://s-1-15-2-178685015-4227303602-993491238-2605550032-2075089136-3243607036-1120404382",
				"U8IMIleETNqDporApjQ1jvoNEtf7ieOv", false);
		api.push(token, new BaseToastMessage("Windows phone"), new Callback<PushNotificationResult>() {

			@Override
			public void apply(PushNotificationResult result) {
